package com.luoyouren.arcamera.rajawali;
...
/**
 * Created by wecut-simon on 2017/8/27.
 */
...
public class CustomVertexShaderMaterialPlugin implements IMaterialPlugin {
    ...
    public CustomVertexShaderMaterialPlugin(float amplitude)
    {
        mVertexShader = new CustomVertexShaderFragment(amplitude);
    }
    ...
    private class CustomVertexShaderFragment extends AShader implements IShaderFragment
    {
        ...
        public CustomVertexShaderFragment(float amplitude) {
            super(ShaderType.VERTEX_SHADER_FRAGMENT);
        ...
        public void initialize()
        {
            ...
            mcStrength = (RFloat) addConst("cStrength", mAmplitude);
        }
