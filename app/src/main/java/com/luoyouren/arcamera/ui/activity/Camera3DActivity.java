...
//                mMask.setZ(0.4f);
                ...
                // 钢铁侠头盔
//                final LoaderOBJ parser = new LoaderOBJ(mContext.getResources(), mTextureManager, R.raw.ironman_mask_open_obj);
//                parser.parse();
//                mMask = parser.getParsedObject();
//                Log.i("somebodyluo", "come on");
//                if (mMask != null)
//                {
//                    Log.i("somebodyluo", "fuck you");
//                    mMask.setScale(0.2f);
//                    mMask.setPosition(0.0f, 0.0f, 0.0f);
//                }
