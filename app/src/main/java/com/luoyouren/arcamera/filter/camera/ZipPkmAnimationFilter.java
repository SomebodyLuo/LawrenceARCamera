package com.luoyouren.arcamera.filter.camera;
...
import com.luoyouren.arcamera.gl.MatrixUtils;
import com.luoyouren.arcamera.gl.ZipPkmReader;
...
public class ZipPkmAnimationFilter extends AFilter {
    ...
    private int type = MatrixUtils.TYPE_CENTER_INSIDE;
    ...
    protected void onBindTexture() {
        ...
        if (t != null && tAlpha != null) {
            MatrixUtils.getMatrix(super.getMatrix(), MatrixUtils.TYPE_FIT_END, t.getWidth(), t.getHeight(), width, height);
...
//        GLES20.glViewport(100,0,width/6,height/6);
        GLES20.glViewport(0, height/4, width, height);
        super.draw();
